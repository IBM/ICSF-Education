/* Rexx */
/*-------------------------------------------------------------------*/
/* Retrieve the attributes of an public RSA TKDS object              */
/*-------------------------------------------------------------------*/

/* TKDS RSA public key handle name                                   */
...
PubKey_Modulus     = x2c(ATTRVAL("CKA_MODULUS",GAV_attrlist))   
PubKey_Pubexp      = x2c(ATTRVAL("CKA_PUBLIC_EXPONENT",GAV_attrlist))           
pubkey_modulus_len = D2C( Length( pubkey_modulus ),2);
pubkey_pubexp_len  = D2C( Length( pubkey_pubexp ),2);

say 'PubKey_Modulus: ' c2x(PubKey_Modulus)
say 'Pubkey_modulus_len: ' c2x(pubkey_modulus_len)

say 'PubKey_Pubexp: '  c2x(PubKey_Pubexp)
say 'Pubkey_pubexp_len: ' c2x(pubkey_pubexp_len)
